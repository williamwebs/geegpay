...
import { menuLists, otherMenu } from "@/constants/menuList";
  ...
  return (
    <div
      className={`mobile_sidebar rounded-full p-3 bg-gray600 dark:bg-white/30 backdrop-blur absolute top-[12%] right-0 ${
        toggleNav ? "mr-0" : "-mr-14"
      } transition-all duration-1000 z-20 `}
    >
      <div className="">
        <div className="logo w-10 h-10 cursor-pointer mb-5 mx-auto">
          ...
          <div>
            ...
            <div className="dark_mode bg-gray200 dark:bg-gray400 rounded-full">
              ...
              <div
                ...
                className={`dark cursor-pointer w-[40px] h-[40px] rounded-full flex items-center justify-center ${
                  theme === "dark" && "rounded-full bg-success"
                } `}
              >
                <svg
                  width="30"
